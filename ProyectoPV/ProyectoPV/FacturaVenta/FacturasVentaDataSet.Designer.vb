...
Partial Public Class FacturasVentaDataSet
    ...
    Partial Public Class VentaDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddVentaRow(ByVal NroFactura As Integer, ByVal Cantidad_Venta As Integer, ByVal ID_Producto As Integer, ByVal Fecha_Venta As Date, ByVal TipoDeFactura_Venta As String, ByVal ID_Cliente As Integer, ByVal ID_Cajero As Integer, ByVal SubTotal As Integer) As VentaRow
            Dim rowVentaRow As VentaRow = CType(Me.NewRow,VentaRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, NroFactura, Cantidad_Venta, ID_Producto, Fecha_Venta, TipoDeFactura_Venta, ID_Cliente, ID_Cajero, SubTotal}
    ...
    Partial Public Class VentaTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Venta] ([NroFactura], [Cantidad_Venta], [ID_Producto], [Fecha_Venta]"& _ 
                ", [TipoDeFactura_Venta], [ID_Cajero], [ID_Cliente], [SubTotal]) VALUES (@p1, @p2"& _ 
                ", @p3, @p4, @p5, @p6, @p7, @p8)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Venta] SET [NroFactura] = @p1, [Cantidad_Venta] = @p2, [ID_Producto] = @p"& _ 
                ...
                "nte] = @p7, [SubTotal] = @p8 WHERE (([ID_Venta] = @p9))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID_Venta, NroFactura, Cantidad_Venta, ID_Producto, Fecha_Venta, TipoDeFact"& _ 
                "ura_Venta, ID_Cajero, ID_Cliente, SubTotal FROM Venta"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal p1 As Integer, ByVal p2 As Integer, ByVal p3 As Integer, ByVal p4 As Date, ByVal p5 As String, ByVal p6 As Integer, ByVal p7 As Integer, ByVal p8 As Global.System.Nullable(Of Integer)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal p1 As Integer, ByVal p2 As Integer, ByVal p3 As Integer, ByVal p4 As Date, ByVal p5 As String, ByVal p6 As Integer, ByVal p7 As Integer, ByVal p8 As Global.System.Nullable(Of Integer), ByVal p9 As Integer) As Integer

Public Class Cajero_Agregar_Cliente
    ...
    Private Sub Btn_Guardar_Clientes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Guardar_Clientes.Click
        ...
        Me.ClienteBindingSource.Current("DNI_Cliente") = Val(DNITextBox.Text)
